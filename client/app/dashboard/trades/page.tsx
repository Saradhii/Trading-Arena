...
function FilterSelect({
  ...
  return (
    <select
      ...
      className="font-pixel-square rounded-xl bg-background/40 px-3 py-2 text-xs tracking-wide text-foreground outline-none ring-1 ring-black/5 hover:text-foreground focus:ring-foreground/30 dark:ring-white/10"
    >
